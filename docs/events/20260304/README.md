...
???- question "Answers"
    ...
    - R: I feel that there are so many variables in teaching,
      ...
      However, I think this is false: we know from Hattie `[Hattie, 2012]`
      the effect size of some interventions on grades, with 0.4
      standard deviations being the average. I feel detecting a grade shift
      of 0.4 would be detectable
    - ...
    - ...
    - ...
